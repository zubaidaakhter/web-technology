...
<body>
  ...
  <ul class="nav-bar">
   ...
   <!--  <li class="nav-bar_item"><a href="">edit table</a></li> -->
    <li class="nav-bar_item"><a href="Transactionhistory.php">Go Back</a></li>
</ul>
</nav>
<div id="searchbox" >
	<h1 align="center">SEARCH MEDICINE TRANSCATION HISTORY</h1>
	<form>
	...
	$(document).ready(function(){
		$("#search").keypress(function(){
			$.ajax({
              ...
              type:'POST',
              url:'../controller/history_search.php',
              data:{
              	name:$("#search").val(),
              },
